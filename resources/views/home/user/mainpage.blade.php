...
<div class="container person">
  <div class="row">
    <div class="col-xs-16 main">
      <div class="main-top">
        <a class="avatar" href="">
          <img src="{{isset($ress->img) ? $ress->img  : '/homes/review/3-9a2bcc21a5d89e21dafc73b39dc5f582.jpg'}}" alt="" style="width:100%">
        </a>
      </div>
              ...
              <div class="content">
                  ...
                  <div class="author">
                      ...
                      <div class="info">
                          ...
                          <span>
                              <a href="/home/content/{{$v->id}}" style="margin-left:100px;color:lightblue">删除文章</a>
                          </span> 
                      </div>
                  </div>
                  <div>
                    <a class="title" target="_blank" href="/home/user/{{$v->id}}">
                        <h3>{{ $v->title }}</h3>
                    </a>
                    <a href="/home/user/{{$v->id}}">
                        <p class="abstract">
                            {{ $v->abstract }}
                        </p>
                    </a>
...
<div class="col-xs-7 col-xs-offset-1 aside">
    <div class="title"><a href="javascript:void(0)"></a>个人介绍</div>
